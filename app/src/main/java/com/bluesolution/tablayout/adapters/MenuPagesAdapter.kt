...
class MenuPagesAdapter(var menuItems: ArrayList<Menu>, fragmentManager: FragmentManager, lifecycle: Lifecycle): FragmentStateAdapter(fragmentManager,lifecycle) {
